            ...
            <form action="" class="col-md-12 center-margin" id="subpackage_frm">
                ...
                <?php if ($pkg->id == 12) { ?>
                    ...
                    <div class="form-row">
                        ...
                        <div class="form-input col-md-6">
                            <input placeholder="Breakfast" class="col-md-3 validate[length[0,3]]" type="text"
                                   name="occupancy" id="occupancy"
                                   value="<?php echo !empty($subpackageInfo->occupancy) ? $subpackageInfo->occupancy : ''; ?>">
                        </div>
                    </div>                    
                    <div class="form-row">
                        ...
                        <div class="form-input col-md-6">
                            <input placeholder="Lunch" class="col-md-3 validate[length[0,3]]" type="text"
                                   name="view" id="view"
                                   value="<?php echo !empty($subpackageInfo->view) ? $subpackageInfo->view : ''; ?>">
                        </div>
                    </div>  
                    <div class="form-row">
                        ...
                        <div class="form-input col-md-4">
                            <input placeholder="Dinner" class="col-md-12" type="text" name="cocktail" id="cocktail"
