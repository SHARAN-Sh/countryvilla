...
<div class="col-md-3" id="previewUserimage1<?php echo $deleteid;?>">
    <div class="infobox info-bg">
        <img src="<?php echo IMAGE_PATH.'mservices/images/thumbnails/'.$val;?>"  style="width:100%"/>
...
//uplodify
  if(isset($_SESSION['imageNameArr'])){
   if(count($_SESSION['imageNameArr'])>0){
      ...
      { 
         @unlink(IMAGE_PATH.'mservices/images/thumbnails/'.$val);
         @unlink(IMAGE_PATH.'mservices/images/'.$val);
      }  
