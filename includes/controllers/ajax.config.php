<?php 
	...
	{		
		...
		case "edit":
			...
			$record->eventno 		= $_REQUEST['eventno'];
			$record->eventmail 		= $_REQUEST['eventmail'];
			$record->roomno 		= $_REQUEST['roomno'];
			$record->roommail 		= $_REQUEST['roommail'];
			$record->dineno 		= $_REQUEST['dineno'];
			$record->dinemail 		= $_REQUEST['dinemail'];
			$record->recreationno 		= $_REQUEST['recreationno'];
			$record->recreationmail 		= $_REQUEST['recreationmail'];
