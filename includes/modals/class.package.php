...
class Package extends DatabaseObject {
	...
	protected static $db_fields = array('id', 'slug', 'image', 'header_image', 'banner_image', 'title', 'sub_title', 'sub_sub_title', 'status', 'sortorder', 'detail', 'content', 'meta_title', 'meta_keywords', 'meta_description', 'type', 'added_date', 'modified_date');
