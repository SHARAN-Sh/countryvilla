...
function getMenuList($caption="", $link="", $type=0, $class="",$nicon=""){
	...
	return "<a href=\"".$linkhref."\" ".$classLink.$idLink.$linkType." >".$caption."</a>" .$nicon;
}
...
function get_front_pagination($total = '', $per_page = '2', $page = '1', $url = '')
{
    ...
    if ($lastpage > 1) {
        $pagination .= "
  			<ul class='pagination'>";
        if ($page > 1)
            $pagination .= "<li><a href='" . $url . '/page/' . $prev . "'><i class='bi bi-arrow-left-short'></i></a></li>";
        else
        ...
        if ($page < $counter - 1)
            $pagination .= "<li><a href='" . $url . '/page/' . $next . "'><i class='bi bi-arrow-right-short'></i></a></li>";
        else
            $pagination .= "<li><a href='javascript:void(0);'><i class='bi bi-arrow-right-short'></i></a></li>";
        $pagination .= "</ul>\n";
    }
